...
/**
 * Specifies the type of access for components when using {@link ComponentAccessor},
 * primarily for coordinating concurrent access in multithreaded environments.
 *
 * <p>This enum determines how {@link QueryResult} and {@link ComponentAccessor} interact
...
public enum AccessType {
    /**
     * Read-only access. Multiple {@link ComponentAccessor}s with {@code READ} access
    ...
    /**
     * Read-Write access. Only one {@link ComponentAccessor} with {@code WRITE} access
